...
class ExampleOrder:
    """Custom ordering for examples, dispatched by subdirectory."""
    ...
    ORDERS = {
        ...
        "advanced": [
            "example_custom_roles.py",
            "example_custom_events.py",
            "example_custom_relationships.py",
            "example_custom_pipeline.py",
        ],
        "extensions": [
            "example_growth_plus.py",
            "example_buffer_stock.py",
            "example_robustness.py",
        ],
    }

    def __init__(self, src_dir):
        self.order = self.ORDERS.get(os.path.basename(os.path.normpath(src_dir)), [])

    def __call__(self, filename):
        try:
            return self.order.index(os.path.basename(filename))
        except ValueError:
...
sphinx_gallery_conf = {
    ...
    "within_subsection_order": ExampleOrder,
