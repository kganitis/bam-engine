...
from bamengine.typing import Float1D, Int1D, Int2D
...
class Employer:
    ...
    recv_job_apps_head: Int1D  # head ptr into recv_job_apps (−1 ⇒ empty)
    recv_job_apps: Int2D  # buffer of worker indices
